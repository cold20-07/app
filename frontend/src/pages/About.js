      ...
      <section className="bg-gradient-to-br from-teal-600 to-emerald-600 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-teal-50">
            Clinician-led, veteran-centered
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg text-center">
            ...
            <p className="text-lg text-slate-700 leading-relaxed mb-6">
              We focus on accurate, ethical medical-legal documentation for U.S. Veterans. Our team includes board-certified physicians and experienced advanced practitioners with VA-familiar training.
            </p>
            <p className="text-lg text-slate-700 leading-relaxed">
              Every nexus letter, DBQ, and consultation is tailored to your specific case, grounded in clinical merit, and designed to help the adjudicator understand your condition.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-slate-200">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Availability</h3>
              <p className="text-slate-700">
                Telehealth nationwide (where permitted); select in-person by appointment
              </p>
            </div>
          </div>
        </div>
