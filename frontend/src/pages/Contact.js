              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-slate-600">support@militarydisabilitynexus.com</div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-slate-600">1-800-VETERAN</div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-slate-600">Nationwide Telehealth</div>
                  </div>
                </div>
              </div>
            </div>
