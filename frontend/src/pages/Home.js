        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
              Veteran-Centered Medical Evidence for <span className="text-teal-600">VA Claims</span>
            </h1>
            <p className="text-lg sm:text-xl text-slate-600 mb-8 leading-relaxed max-w-2xl mx-auto">
              Claimant-specific medical evidence. Ethical, accurate, veteran-centered. Get nexus letters, DBQs, and expert guidance from licensed clinicians.
            </p>
              ...
              {services.map((service) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-slate-600 mb-4 text-sm">{service.shortDescription}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              { step: '04', title: 'Receive Documentation', desc: 'Get your completed nexus letter or DBQ' },
            ].map((item, idx) => (
