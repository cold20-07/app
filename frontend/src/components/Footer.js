      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-slate-400 mb-4 max-w-md">
              Clinician-led, veteran-centered medical evidence for U.S. Veterans. Ethical, accurate documentation.
            </p>
            <div className="space-y-2 text-sm">
              <div className="flex items-center space-x-2">
                <Mail className="w-4 h-4 text-teal-500" />
                <span>support@militarydisabilitynexus.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <MapPin className="w-4 h-4 text-teal-500" />
                <span>Nationwide Telehealth</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/services/nexus-letters" className="hover:text-teal-400 transition-colors">
                  Nexus Letters
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 text-sm">
          <p className="text-slate-500">
            © {currentYear} Military Disability Nexus. All rights reserved.
          </p>
